...
<Example
  ...
  code={`import { ConfettiButton } from "@/components/myndui/confetti";
...
mirroring the `toast()` ergonomics used elsewhere in Myndui.
...
```tsx
import { ConfettiButton } from "@/components/myndui/confetti";
```
...
```tsx
import { Confetti, type ConfettiHandle } from "@/components/myndui/confetti";
...
```tsx
import { confetti } from "@/components/myndui/confetti";
