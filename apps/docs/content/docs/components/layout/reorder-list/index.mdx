...
import { ReorderList, ReorderItem } from "@myndui/components";
...
<Example
  ...
  code={`import { ReorderList, ReorderItem } from "@/components/myndui/reorder-list";
...
```tsx
import { ReorderList, ReorderItem } from "@/components/myndui/reorder-list";
```
