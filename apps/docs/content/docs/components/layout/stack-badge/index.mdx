...
<Example
  ...
  code={`import { StackBadge } from "@/components/myndui/stack-badge";
...
```tsx
import { StackBadge } from "@/components/myndui/stack-badge";
```
...
```tsx
import { TECH, type TechKey } from "@/components/myndui/stack-badge";
```
