...
<Example
  ...
  code={`import { ProgressiveCardReveal } from "@/components/myndui/progressive-card-reveal";
...
```tsx
import { ProgressiveCardReveal } from "@/components/myndui/progressive-card-reveal";
```
