...
<Example
  ...
  code={`import { HolographicCard } from "@/components/myndui/holographic-card";
...
export function HolographicCardDemo() {
  return (
    <HolographicCard variant="rainbow" className="h-96 w-72 p-6">
      ...
      <div className="mt-32">
        <h3 className="text-2xl font-semibold tracking-tight text-white">Myndui</h3>
...
```tsx
import { HolographicCard } from "@/components/myndui/holographic-card";
```
