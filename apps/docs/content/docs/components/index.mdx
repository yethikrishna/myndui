---
title: Components
description: Browse the full Myndui component collection.
---
...
<Cards>
  ...
  <PreviewCard href="/docs/components/buttons/jelly-button" title="Jelly Button">
    A squishy button that deforms on press and springs back with a jelly wobble
    — all on the compositor.
  </PreviewCard>
  ...
  <PreviewCard href="/docs/components/buttons/multi-button" title="Multi Button">
    A compact action rail that reveals labels on hover, focus, or touch without
    losing its pill-shaped footprint.
  </PreviewCard>
...
<Cards>
  ...
  <PreviewCard href="/docs/components/layout/split-flap-display" title="Split-Flap Display">
    A Solari departure board where each character spins through the charset on
    flip leaves, settling on the value with a staggered column wave.
  </PreviewCard>
...
<Cards>
  <PreviewCard href="/docs/components/effects/ascii-dither" title="ASCII Dither">
