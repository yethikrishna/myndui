...
<Example
  ...
  code={`import { OrbitingCircles } from "@/components/myndui/orbiting-circles";

export function OrbitingCirclesDemo() {
  return (
    <div className="relative flex h-[360px] w-full items-center justify-center">
      <span className="z-10 rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground">Myndui</span>
...
```tsx
import { OrbitingCircles } from "@/components/myndui/orbiting-circles";
```
