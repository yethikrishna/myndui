...
description: The philosophy behind every animation in Myndui — twelve principles, each with a live demo.
full: true
---

import { MotionPrinciples } from "@/components/motion-guidelines/motion-principles";

Motion in Myndui is never decoration. Every animation earns its place by making
