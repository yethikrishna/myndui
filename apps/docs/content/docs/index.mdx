...
**Myndui** is a collection of open-source, animated UI components for Design
...
<ComponentPreview code={`import { MagicButton } from "@myndui/components";
...
<Cards>
  <Card href="/docs/installation" title="Installation">
    Add the `@myndui` registry and pull your first component in minutes.
  </Card>
